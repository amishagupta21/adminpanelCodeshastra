            ...
            <Row>
                <Col md={12}>
                    ...
                    <div className="d-flex justify-content-between my-4">
                        <h4>ALL BATCHES</h4>
                         <Button color="success" className='rounded-pill mb-3'onClick={toggle} >
                            + Create New Batch
                        </Button>
                        ...
                        <Modal isOpen={modal} toggle={toggle} fade={false} centered size="lg">
                            ...
                            <ModalFooter>
                                ...
                                <Button color="primary" onClick={toggle} className='px-5'>Create</Button>
                            </ModalFooter>
                        </Modal>
                                        ...
                                        <div className="box-r-btn">
                                            ...
                                            <div className="ms-lg-3 mb-3">
                                                <Input type="select" >
                                                    ...
                                                    <option>Full Stack Web Developer Program</option>
                                                    <option>Data Science</option>
                                                </Input>
                                            </div>
                                            <div className="ms-lg-3 mb-3">
                                                <Button color="secondary" ><i className="mdi mdi-filter"></i> Apply Fillter</Button>
                                            </div>
                                            <div className='ms-lg-3 mb-3'>
                                                <Input type="select"  >
